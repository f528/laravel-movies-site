...
<img src="{{ 'https://image.tmdb.org/t/p/w500' . $showMovies['backdrop_path'] }}" alt="the rings of power" class="w-96 ">
            <div class="ml-4 mt-8">
                ...
                <div class="mt-12 ">
                    ...
                    <div class="flex">
                        <div class=" mt-4 ">
                            <div>Bong Joi Hu</div>
                            <div class="text-sm text-gray-400"> Screenplay, Derector, Story</div>
                        </div>
                        <div class="mt-5 ml-8">
                            <div>Hain Jin Wou</div>
    ...
    <div class="container mx-auto px-4 py-16">
        <h2 class="text-4xl font-semibold">Cast</h2>
           ...
           <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 ">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/assets/actors/euDPyqLnuwaWMHajcU3oZ9uZezR.webp" alt="film"class="hover:opacity-75 transaction ease-in-out duration-150">
                    </a>
                    <div class="mt-2">

                        {{-- discription-movie --}}
                        <a href="#" class="text-lg mt-2 hover:text-gray:300">Only Morders</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/assets/5.webp" alt="film"class="hover:opacity-75 transaction ease-in-out duration-150">
                    </a>
                    <div class="mt-2">

                        {{-- discription-movie --}}
                        <a href="#" class="text-lg mt-2 hover:text-gray:300">The Bear</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                            <span> <svg class="fill-current text-orange-500" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/2000/xlink"
                                    width="21px" height="20px">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/assets/6.webp" alt="film"class="hover:opacity-75 transaction ease-in-out duration-150">
                    </a>
                    <div class="mt-2">

                        {{-- discription-movie --}}
                        <a href="#" class="text-lg mt-2 hover:text-gray:300">Oppenheimer</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                            <span> <svg class="fill-current text-orange-500" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/2000/xlink"
                                    width="21px" height="20px">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/assets/10.webp" alt="film"class="hover:opacity-75 transaction ease-in-out duration-150">
                    </a>
                    <div class="mt-2">

                        {{-- discription-movie --}}
                        <a href="#" class="text-lg mt-2 hover:text-gray:300">Strays</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                            <span> <svg class="fill-current text-orange-500" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/2000/xlink"
                                    width="21px" height="20px">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/assets/14.webp" alt="film"class="hover:opacity-75 transaction ease-in-out duration-150">
                    </a>
                    <div class="mt-2">

                        {{-- discription-movie --}}
                        <a href="#" class="text-lg mt-2 hover:text-gray:300">Demon Slayer</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                            <span> <svg class="fill-current text-orange-500" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/2000/xlink"
                                    width="21px" height="20px">
    ...
    <div class="container mx-auto px-4 py-16">
        <h2 class="text-4xl font-semibold">Screenshot</h2>
           ...
           <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8 ">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img  src="/assets/screenshots/download (1).jpeg" alt="film"class="hover:opacity-75 transaction ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/assets/screenshots/download (4).jpeg" alt="film"class="hover:opacity-75 transaction ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/assets/screenshots/download.jpeg" alt="film"class="hover:opacity-75 transaction ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/assets/screenshots/images (1).jpeg" alt="film"class="hover:opacity-75 transaction ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/assets/screenshots/images (2).jpeg" alt="film"class="hover:opacity-75 transaction ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/assets/screenshots/images.jpeg" alt="film"class="hover:opacity-75 transaction ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
